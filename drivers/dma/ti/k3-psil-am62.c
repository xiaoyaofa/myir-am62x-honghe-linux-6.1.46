...
static struct psil_ep am62_src_ep_map[] = {
	...
	/* PDMA_MAIN0 - SPI0-3 */
	PSIL_PDMA_XY_PKT(0x4300),//add by xie
	PSIL_PDMA_XY_PKT(0x4301),//add by xie
	...
	// PSIL_PDMA_XY_PKT(0x430c),//add by xie
	// PSIL_PDMA_XY_PKT(0x430d),//add by xie
	/* PDMA_MAIN1 - UART0-6 */
...
static struct psil_ep am62_dst_ep_map[] = {
	...
	/* PDMA_MAIN0 - SPI0-3 */
	PSIL_PDMA_XY_PKT(0xc300),//add by xie
	PSIL_PDMA_XY_PKT(0xc301),//add by xie
	...
	// PSIL_PDMA_XY_PKT(0xc30c),//add by xie
	// PSIL_PDMA_XY_PKT(0xc30d),//add by xie
	/* PDMA_MAIN1 - UART0-6 */
